                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="auth.php" enctype="multipart/form-data">
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="inputFirstName" name="first" type="text" placeholder="Enter your first name" />
                                                        <label for="inputFirstName">First name</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="inputLastName" type="text" name="last" placeholder="Enter your last name" />
                                            ...
                                            <div class="mb-3">
                                                <label for="inputFile">Add Profile </label>
                                                <input class="form-control" id="inputFile" type="file" name="profile" />
                                            </div>
                                            <div class="mt-4 mb-0">
